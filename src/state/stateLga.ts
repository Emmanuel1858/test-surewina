export const stateLgaData: { [key: string]: string[] } = {
    Abia: [
    ...
    Ondo: [
        ...
        'Irele', 'Odigbo', 'Okitipupa', 'Ondo East', 'Ondo West', 'Os/ogbo', 'Owo'
    ],
    Osun: [
        'Aiyedaade', 'Aiyedire', 'Atakunmosa East', 'Atakunmosa West', 'Boluwaduro',
        'Boripe', 'Ede North', 'Ede South', 'Ife Central', 'Ife East', 'Ife North', 'Ife South',
        'Ifedayo', 'Ifelodun', 'Ila', 'Ilesa East', 'Ilesa West', 'Irepodun', 'Irewole',
        'Isokan', 'Iwo', 'Obokun', 'Odo-Otin', 'Ola-Oluwa', 'Olorunda', 'Oriade', 'Orolu',
        'Osogbo'
    ],
    Oyo: [
    ...
    Zamfara: [
        ...
        'Kaura Namoda', 'Maradun', 'Maru', 'Shinkafi', 'Talata Mafara', 'Chafe'
    ]
