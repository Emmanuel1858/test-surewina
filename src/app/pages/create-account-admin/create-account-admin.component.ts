...
export class CreateAccountAdminComponent {
  ...
  navigateToPassword() {
    const isValid =
      ...
      !this.isEmpty(this.selectedState)&&
      !this.isEmpty(this.selectedLga)
    ...
    if (isValid) {
      ...
      this.dataService.setRegisterUserData('state', this.selectedState)
      this.dataService.setRegisterUserData('lga', this.selectedLga)
  ...
  ngOnInit(): void {
    ...
    this.selectedLga = this.dataService.getRegisterUserData('lga') || ''
    this.selectedState = this.dataService.getRegisterUserData('state') || ''
